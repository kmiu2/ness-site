export const initialCourses = [
  {
    course_code: 'NE 100',
    course_name: 'Introduction to Nanotechnology Engineering',
    course_desc:
  ...
  },
  {
    ...
    course_desc:
      'Introduction to types of nanomaterials hazards their identification, toxicity, and characterization; exposure health-risk assessment; cancer and non-cancer risks. Areas of research and professional practice in nanotechnology engineering; exposure to concepts from other engineering plans; support material for the 1B academic term, including aspects of co-operative education and professional or career development. [Note: This course is graded as CR/NCR and is considered as DRNC. Offered: W]',
  ...
  {
    course_code: 'NE 112',
    course_name: 'Linear Algebra for Nanotechnology Engineers',
    course_desc:
    ...
    course_prereq:
      'Prereq: 1A Nanotechnology Engineering. Antireq: MATH 114, 115, 106, 136, 146, SYDE 114',
    term: '1A',
    x: 0,
    y: 300,
  },
  {
    ...
    course_prereq:
      'Prereq: Level at least 1B Nanotechnology Engineering. Antireq: CIVE 121, CS 115, 135, 145, ECE 150, MTE 121, SYDE 121',
    term: '1B',
    x: 200,
    y: 200,
  },
  {
    course_code: 'NE 121',
    course_name: 'Chemical Principles',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level 1A Nanotechnology Engineering. Antireq: CHE 102, CHEM 120, 123',
    term: '1A',
    x: 0,
    y: 400,
  },
  {
    ...
    course_prereq:
      'Prereq: NE 121; Level at least 1B Nanotechnology Engineering. Antireq: CHE 241, CIVE 265, ME 235',
    term: '1B',
    x: 200,
    y: 300,
  },
  {
    ...
    course_prereq:
      'Prereq: MATH 117; Level at least 1B Nanotechnology Engineering. Antireq: BME 182, CIVE 104, ECE 105, PHYS 111, 115, 121, SYDE 182',
    term: '1B',
    x: 200,
    y: 400,
  },
  {
    ...
    course_prereq:
      'Prereq: Level at least 1B Nanotechnology Engineering. Antireq: AE 123, (BME 294 and BME 294L), CIVE 123, ECE 140, ENVE 123, GENE 123, GEOE 123, ME 123, MTE 120, SYDE 292',
    term: '1B',
    x: 200,
    y: 500,
  },
  {
    course_code: 'NE 201',
    course_name: 'Nanotoxicology; Nanotechnology Engineering Practice',
    course_desc:
      'Nanotoxicology, including inhalation and dermal exposure effects; translocation, cytotoxicity, mutagenicity, and neurotoxicity; carbon nanotubes as cancer hazards. Areas of research and professional practice in nanotechnology engineering; exposure to concepts from other engineering plans; support material for the 2A academic term, including aspects of co-operative education and professional or career development. [Note: This course is graded as CR/NCR and is considered as DRNC. Offered: F]',
    course_prereq: 'Prereq: 2A Nanotechnology Engineering',
    term: '2A',
    x: 400,
    y: 0,
  },
  {
    ...
    course_desc:
      'Environmental fate and behaviour, bio-availability, consumer exposure, environmental exposure-assessment, aquatic toxicology, bio-accumulation and biomagnification. Areas of research and professional practice in nanotechnology engineering; exposure to concepts from other engineering plans; support material for the 2B academic term, including aspects of co-operative education and professional or career development. [Note: This course is graded as CR/NCR and is considered as DRNC. Offered: S]',
  ...
  },
  {
    ...
    course_prereq:
      'Prereq: MATH 119, NE 112; Level at least 2A Nanotechnology Engineering. Antireq: CHE 220, CIVE 224, ME 202, STAT 202, 206, 220, 230, SYDE 213',
    term: '2A',
    x: 400,
    y: 100,
  },
  {
    course_code: 'NE 216',
    course_name: 'Advanced Calculus and Numerical Methods 1',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 2A Nanotechnology Engineering Antireq: AMATH 350, MATH 218, 228',
    term: '2A',
    x: 400,
    y: 200,
  },
  {
    course_code: 'NE 217',
    course_name: 'Advanced Calculus and Numerical Methods 2',
    course_desc:
  ...
  {
    course_code: 'NE 220L',
    course_name: 'Materials Science and Engineering Laboratory',
    course_desc:
  ...
  {
    course_code: 'NE 222',
    course_name: 'Organic Chemistry for Nanotechnology Engineers',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 2A Nanotechnology Engineering. Antireq: (CHEM 262 and 262L), 264, (CHEM 266 and 266L)',
    term: '2A',
    x: 400,
    y: 400,
  },
  {
    course_code: 'NE 225',
    course_name: 'Structure and Properties of Nanomaterials',
    course_desc:
  ...
  {
    course_code: 'NE 226',
    course_name: 'Characterization of Materials',
    course_desc:
  ...
  {
    course_code: 'NE 226L',
    course_name: 'Laboratory Characterization Methods',
    course_desc:
  ...
  },
  {
    ...
    course_prereq:
      'Prereq: Level at least 2A Nanotechnology Engineering. Antireq: ECE 106, MTE 120, SYDE 283',
    term: '2A',
    x: 400,
    y: 600,
  },
  {
    ...
    course_prereq:
      'Prereq: Level at least 2B Nanotechnology Engineering.  Antireq: ECE 231',
    term: '2B',
    x: 600,
    y: 400,
  },
  {
    course_code: 'NE 281',
    course_name: 'Biology for Nanotechnology Engineers',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 2A Nanotechnology Engineering. Antireq: BIOL 130, CHE 161, BME 285',
    term: '2B',
    x: 600,
    y: 500,
  },
  {
    ...
    course_desc:
      'Detoxification and bioactivation pathways; surface modification; biopersistence; quantum dots and cellular imagining; biomedical applications of nanomaterials. Areas of research and professional practice in nanotechnology engineering; exposure to concepts from other engineering plans; support material for the 3A academic term, including aspects of co-operative education and professional or career development. [Note: This course is graded as CR/NCR and is considered as DRNC. Offered: S]',
  ...
  {
    course_code: 'NE 318',
    course_name: 'Continuum Mechanics for Nanotechnology Engineering',
    course_desc:
  ...
  {
    course_code: 'NE 320L',
    course_name: 'Characterization of Materials Laboratory',
    course_desc:
  ...
  {
    course_code: 'NE 330L',
    course_name: 'Macromolecular Science Laboratory',
    course_desc:
  ...
  },
  {
    ...
    course_prereq:
      'Prereq: Level at least 3A Nanotechnology Engineering. Antireq: CHEM 356, ECE 405, PHYS 233, 234',
    term: '3A',
    x: 800,
    y: 300,
  },
  {
    ...
    course_prereq:
      'Prereq: NE 225; 3A Nanotechnology Engineering. Antireq: CHE 541, CHEM 370, MNS 322',
    term: '3A',
    x: 800,
    y: 400,
  },
  {
    course_code: 'NE 334',
    course_name: 'Statistical Thermodynamics',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 3B Nanotechnology Engineering. Antireq: CHEM 400 (Topic: Statistical Mechanics), PHYS 359',
    term: '3B',
    x: 1000,
    y: 200,
  },
  {
    course_code: 'NE 335',
    course_name: 'Soft Nanomaterials',
    course_desc:
    ...
    course_prereq:
      'Prereq: NE 333; Level at least 3B Nanotechnology Engineering. Antireq: CHE 541',
    term: '3B',
    x: 1000,
    y: 300,
  },
  {
    course_code: 'NE 336',
    course_name: 'Micro and Nanosystem Computer-aided Design',
    course_desc:
  ...
  {
    course_code: 'NE 340L',
    course_name: 'Microfabrication and Thin-film Technology Laboratory',
    course_desc:
  ...
  {
    course_code: 'NE 343',
    course_name: 'Microfabrication and Thin-film Technology',
    course_desc:
    ...
    course_prereq:
      'Prereq: NE 121, 125, 242; 3A Nanotechnology Engineering. Antireq: ECE 433',
    term: '3A',
    x: 800,
    y: 500,
  },
  {
    ...
    course_prereq:
      'Prereq: Level at least 3B Nanotechnology Engineering. Antireq: ECE 240, 242, 340, SYDE 292',
    term: '3B',
    x: 1000,
    y: 600,
  },
  {
    course_code: 'NE 345',
    course_name: 'Photonic Materials and Devices',
    course_desc:
  ...
  {
    course_code: 'NE 350',
    course_name: 'Work-term Report 2',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 3B Nanotechnology Engineering. Antireq: MSCI 392, WKRPT 300, 301',
    term: '3B',
    x: 1000,
    y: 800,
  },
  {
    ...
    course_prereq:
      'Prereq: Level at least 3B Nanotechnology Engineering. Antireq: CHEM 400 (Topic: Surface Science and Nanotechnology)',
    term: '3B',
    x: 1000,
    y: 900,
  },
  {
    course_code: 'NE 353',
    course_name: 'Nanoprobing and Lithography',
    course_desc:
  ...
  {
    course_code: 'NE 381',
    course_name: 'Introduction to Nanoscale Biosystems',
    course_desc:
  ...
  {
    course_code: 'NE 409',
    course_name: 'Nanosystems Design Project and Symposium',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 408; 4B Nanotechnology Engineering',
    term: '4B',
    x: 1400,
    y: 0,
  },
  {
    course_code: 'NE 450',
    course_name: 'Work-term Report 3',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 4B Nanotechnology Engineering. Antireq: MSCI 491, WKRPT 400, 401',
    term: '4B',
    x: 1400,
    y: 100,
  },
  {
    course_code: 'NE 451',
    course_name: 'Simulation Methods',
    course_desc:
  ...
  {
    course_code: 'NE 452',
    course_name: 'Special Topics in Nanoscale Simulations',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 451; 4B Nanotechnology Engineering',
    term: '4B',
    x: 1400,
    y: 200,
  },
  {
    course_code: 'NE 453',
    course_name: 'Special Topics in Nanotechnology Engineering',
    course_desc:
    ...
    course_prereq: 'Prereq: Nanotechnology Engineering',
    term: '4A',
    x: 1200,
    y: 200,
  },
  {
    course_code: 'NE 454A',
    course_name: 'Nano-electronics Laboratory 1',
    course_desc:
    ...
    course_prereq: 'Prereq: 4A Nanotechnology Engineering',
    term: '4A',
    x: 1200,
    y: 300,
  },
  {
    course_code: 'NE 454B',
    course_name: 'Nano-instrumentation Laboratory 1',
    course_desc:
  ...
  {
    course_code: 'NE 454C',
    course_name: 'Nanobiosystems Laboratory 1',
    course_desc:
  ...
  {
    course_code: 'NE 454D',
    course_name: 'Nanostructured Materials Laboratory 1',
    course_desc:
  ...
  {
    course_code: 'NE 455A',
    course_name: 'Nano-electronics Laboratory 2',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 454A; 4B Nanotechnology Engineering',
    term: '4B',
    x: 1400,
    y: 300,
  },
  {
    course_code: 'NE 455B',
    course_name: 'Nano-instrumentation Laboratory 2',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 454B; 4B Nanotechnology Engineering',
    term: '4B',
    x: 1400,
    y: 400,
  },
  {
    course_code: 'NE 455C',
    course_name: 'Nanobiosystems Laboratory 2',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 454C; 4B Nanotechnology Engineering',
    term: '4B',
    x: 1400,
    y: 500,
  },
  {
    course_code: 'NE 455D',
    course_name: 'Nanostructured Materials Laboratory 2',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 454D; 4B Nanotechnology Engineering',
    term: '4B',
    x: 1400,
    y: 600,
  },
  {
    course_code: 'NE 459',
    course_name: 'Nanotechnology Engineering Research Project',
    course_desc:
    ...
    course_prereq: 'Prereq: 4B Nanotechnology Engineering',
    term: '4B',
    x: 1400,
    y: 700,
  },
  {
    course_code: 'NE 461',
    course_name: 'Micro and Nano-instrumentation',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 352, 353; 4A Nanotechnology Engineering',
    term: '4A',
    x: 1200,
    y: 700,
  },
  {
    course_code: 'NE 466',
    course_name: 'Tactile Sensors and Transducers',
    course_desc:
  ...
  {
    course_code: 'NE 476',
    course_name: 'Organic Electronics',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 3B Electrical Engineering or Nanotechnology Engineering. Antireq: NE 479 (Topic: Organic Electronics); NE 499 (Topic: Materials 4 Printed Electronics)',
    term: '4B',
    x: 1400,
    y: 900,
  },
  {
    course_code: 'NE 481',
    course_name: 'Nanomedicine and Nanobiotechnology',
    course_desc:
  ...
  {
    course_code: 'NE 487',
    course_name: 'Microfluidic and Nanobiotechnological Systems',
    course_desc:
  ...
  {
    course_code: 'NE 488',
    course_name: 'Biomaterials and Biomedical Design',
    course_desc:
    ...
    course_prereq:
      'Prereq: NE 481; Level at least 3B Biomedical Engineering or Nanotechnology Engineering. Antireq: BME 489 (Topic: Biocompatibility and Biomaterial Engineering), CHE 561',
    term: '4B',
    x: 1400,
    y: 1100,
  },
  {
    course_code: 'NE 491',
    course_name: 'Nanostructured Materials',
    course_desc:
    ...
    course_prereq: 'Prereq: NE 335, 352; 4A Nanotechnology Engineering',
    term: '4A',
    x: 1200,
    y: 1100,
  },
  {
    course_code: 'NE 496',
    course_name: 'Nanomaterials for Electrochemical Energy Systems',
    course_desc:
    ...
    course_prereq:
      'Prereq: Level at least 3B Nanotechnology Engineering. Antireq: CHE 331, NE 499 (Topic: Nanomaterials and Sustainable Energy)',
    term: '4B',
    x: 1400,
    y: 1200,
  },
  {
    course_code: 'MATH 117',
